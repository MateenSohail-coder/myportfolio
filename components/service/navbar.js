...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
          <div className="text-3xl font-bold font-anton text-gray-800 flex items-center">
            <svg
              ...
              viewBox="0 0 32 32"
              className="h-13 w-13 cursor-pointer hover:opacity-80 transition fill-blue-600"
            >
          ...
          <div className="hidden md:flex font-antic font-extrabold space-x-8">
            <Link
              ...
              className={`transition-all duration-300 px-4 py-1 rounded-full  ${
                activeSection === "hero" ? "bg-blue-600 text-white" : ""
              }`}
              onMouseEnter={(e) =>
            ...
            <Link
              href="#about"
              className={`transition-all duration-300 px-4 py-1 rounded-full  ${
                activeSection === "about" ? "bg-blue-600 text-white" : ""
              }`}
              onMouseEnter={(e) =>
                gsap.to(e.target, { scale: 1.1, duration: 0.2 })
              }
            ...
            <Link
              href="#services"
              className={`transition-all duration-300 px-4 py-1 rounded-full  ${
                activeSection === "services" ? "bg-blue-600 text-white" : ""
              }`}
              onMouseEnter={(e) =>
                gsap.to(e.target, { scale: 1.1, duration: 0.2 })
              }
            ...
            <Link
              href="#skills"
              className={`transition-all duration-300 px-4 py-1 rounded-full  ${
                activeSection === "skills" ? "bg-blue-600 text-white" : ""
              }`}
              onMouseEnter={(e) =>
                gsap.to(e.target, { scale: 1.1, duration: 0.2 })
              }
            ...
            {/* <Link
              href="#projects"
              className={`transition-all duration-300 px-4 py-1 rounded-full  ${
                activeSection === "projects" ? "bg-blue-600 text-white" : ""
              }`}
              onMouseEnter={(e) =>
                gsap.to(e.target, { scale: 1.1, duration: 0.2 })
              }
            ...
            <Link
              href="#contact"
              className={`transition-all duration-300 px-4 py-1 rounded-full  ${
                activeSection === "contact" ? "bg-blue-600 text-white" : ""
              }`}
              onMouseEnter={(e) =>
                gsap.to(e.target, { scale: 1.1, duration: 0.2 })
              }
      ...
      {isOpen && (
        <div
          className="fixed inset-0 bg-black/3 bg-opacity-50 z-40 md:hidden"
          onClick={() => setIsOpen(false)}
        ></div>
      )}
      <aside
        ref={sidebarRef}
        className="fixed top-0 left-0 bottom-0 w-64 bg-white shadow-lg z-50 transform -translate-x-full md:hidden"
      >
        <div className="flex flex-col h-full">
          <div className="flex justify-between items-center p-4 border-b border-gray-200">
            <div className="text-2xl font-bold font-anton text-gray-800">
              Menu
            </div>
            <button
              onClick={() => setIsOpen(false)}
          ...
          <nav className="flex-grow px-4 py-6 space-y-4 font-antic font-extrabold overflow-y-auto">
            <Link
              ref={(el) => (menuLinksRef.current[0] = el)}
              href="#hero"
              className={`block text-lg px-3 py-2 rounded transition-colors duration-300 ${
                activeSection === "hero"
